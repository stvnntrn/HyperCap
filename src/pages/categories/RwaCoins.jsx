  ...
  const generateLineChart = (data, isPositive = true) => {
    ...
    return (
      <svg width={width} height={height} className="w-full">
          ...
          return (
            <g key={`point-${i}`}>
              <circle
                ...
                cy={y}
                r="4"
                className="opacity-0 hover:opacity-100 fill-[#00FA9A] transition-opacity duration-200"
              />
        ...
        <path
          d={pathString}
          stroke={isPositive ? "#00FA9A" : "#ef4444"}
          strokeWidth="2"
          fill="none"
        />
        <path
          ...
          fill={
            isPositive ? "rgba(0, 250, 154, 0.1)" : "rgba(239, 68, 68, 0.1)"
          }
        />
      </svg>
    );
