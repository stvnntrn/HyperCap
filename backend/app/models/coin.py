...
class Coin(Base):
    ...
    volume_24h_usd = Column(Float)  # 24h trading volume in USD (total value traded)
    volume_24h_base = Column(Float)  # 24h base asset volume (amount of coins traded)
    ...
    market_cap_rank = Column(Integer)  # CoinMarketCap ranking
