...
const SmartContractCoins = () => {
  ...
  const getMarketCapRanking = () => {
    const sortedByMarketCap = [...smartContractCoins].sort(
  ...
  const totalMarketCap = smartContractCoins.reduce(
    (sum, coin) => sum + coin.marketCap,
    0
  );
  const totalVolume = smartContractCoins.reduce(
  ...
  const getSortedCoins = () => {
    let filteredCoins = [...smartContractCoins];
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-4 rounded-xl shadow-[0_4px_12px_-2px_rgba(0,0,0,0.15)] hover:shadow-[0_6px_16px_-2px_rgba(0,0,0,0.2)] transition-all overflow-hidden bg-white">
            <div className="text-base text-indigo-600 font-medium flex items-center gap-2 px-4 pt-4 pb-2">
              <TrendingUp size={16} />
              Trending
            </div>
            <div className="">
              {trendingSmartContractCoins.map((coin, index) => (
                <div
                  key={index}
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">
          Smart Contract Cryptocurrency Prices by Market Cap
        </h2>
