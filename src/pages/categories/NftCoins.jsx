  ...
  return (
    <div className="container mx-auto bg-white text-gray-800 p-6 rounded-xl">
      <div className="mb-8">
        ...
        >
          <div
            className="absolute h-full w-full rounded-full bg-gradient-to-r from-[#4B0082] to-[#8A2BE2] transition-all duration-300 ease-in-out"
            style={getTabStyle()}
          />
          {[
            {
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex flex-wrap gap-1 p-1 w-fit">
            {[
              ...
              >
                <span
                  className={`mr-1.5 ${
                    category.id === "nft" ? "text-[#4B0082]" : "text-gray-400"
                  }`}
                >
                  {category.icon}
                </span>
          ...
          <div className="relative">
            <input
              ...
              className="pl-10 pr-4 py-1.5 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#4B0082] focus:border-transparent text-sm"
            />
            <Search
              size={16}
        ...
        <div className="overflow-hidden rounded-xl">
          <table className="min-w-full table-fixed">
            <thead className="bg-gradient-to-r from-[#4B0082] to-[#8A2BE2]">
              <tr>
                ...
                <th className="py-4 pl-7 text-left text-xs font-medium text-white uppercase tracking-wider">
                  <div className="flex items-center gap-1">
                    <span
                      className="cursor-pointer hover:text-[#8A2BE2] transition-colors"
            ...
            <tbody className="divide-y divide-gray-200 bg-white">
              {getSortedCoins().map((coin) => {
                ...
                return (
                  <tr
                    key={coin.id}
                    className="hover:bg-[#4B0082]/10 transition-colors cursor-pointer"
                  >
                    ...
                    <td className="py-4 pl-7 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="h-8 w-8 rounded-full bg-gradient-to-br from-[#4B0082] to-[#8A2BE2] flex items-center justify-center text-white font-bold mr-3 shadow-md">
                          {coin.symbol.charAt(0)}
                        </div>
