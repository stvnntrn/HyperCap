...
const InfrastructureCoins = () => {
  ...
  const getMarketCapRanking = () => {
    const sortedByMarketCap = [...infrastructureCoins].sort(
  ...
  const totalMarketCap = infrastructureCoins.reduce(
    (sum, coin) => sum + coin.marketCap,
    0
  );
  const totalVolume = infrastructureCoins.reduce(
    (sum, coin) => sum + coin.volume,
    0
  );

  // Get trending Infrastructure coins by volume
  const trendingInfrastructureCoins = [...infrastructureCoins]
    .sort((a, b) => b.volume - a.volume)
    .slice(0, 3);

  // Get top gainers
  const topGainers = [...infrastructureCoins]
    .sort((a, b) => b.change24h - a.change24h)
    .slice(0, 3);

  // Get newly listed coins (using market cap as a proxy for listing time)
  const newlyListed = [...infrastructureCoins]
  ...
  const getSortedCoins = () => {
    let filteredCoins = [...infrastructureCoins];
    ...
    <div className="container mx-auto bg-white text-gray-800 p-6 rounded-xl">
      <div className="mb-8">
        ...
        <h2 className="text-2xl font-bold mb-4 mt-8">
          Infrastructure Cryptocurrency Prices by Market Cap
        </h2>
