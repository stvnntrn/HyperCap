  ...
  const generateLineChart = (data, isPositive = true) => {
    ...
    return (
      <svg width={width} height={height} className="w-full">
          ...
          return (
            <g key={`point-${i}`}>
              <circle
                ...
                cy={y}
                r="4"
                className="opacity-0 hover:opacity-100 fill-[#FF9A4B] transition-opacity duration-200"
              />
        ...
        <path
          d={pathString}
          stroke={isPositive ? "#FF9A4B" : "#ef4444"}
          strokeWidth="2"
          fill="none"
        />
        <path
          ...
          fill={
            isPositive ? "rgba(255, 154, 75, 0.1)" : "rgba(239, 68, 68, 0.1)"
          }
        />
      </svg>
    );
